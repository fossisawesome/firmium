...
import com.fossisawesome.firmium.wear.BuildConfig
...
// OpenSubsonic REST client. Verbatim port of the phone's ApiClient.kt (same package name,
// separate APK) — see the watch API client spec for why auth is a WatchAuthManager instead
// of the phone's AuthManager. All endpoints return parsed domain models; raw JSON parsing
// is contained here.
class ApiClient(private val auth: WatchAuthManager) {
