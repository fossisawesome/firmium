...
// Style enums (GradientMode, LineStyle, BarsGradientMode, BarsGradientOrientation,
// BarsPeakGradientMode, BarsPeakMode) live in firmium_backend::viz_enums since
// backend/config.rs's persisted Config also needs them and can't depend on iced.
pub use firmium_backend::viz_enums::{
